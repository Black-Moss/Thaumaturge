...
public record MultiblockRecipeDisplay(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, MultiblockRecipeDisplay> STREAM_CODEC = StreamCodec.composite(
            Identifier.STREAM_CODEC, MultiblockRecipeDisplay::blueprint,
            SlotDisplay.STREAM_CODEC, MultiblockRecipeDisplay::result,
