...
public record CrucibleRecipeDisplay(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, CrucibleRecipeDisplay> STREAM_CODEC = StreamCodec.composite(
            SlotDisplay.STREAM_CODEC, CrucibleRecipeDisplay::catalyst,
            AspectList.STREAM_CODEC, CrucibleRecipeDisplay::aspects,
