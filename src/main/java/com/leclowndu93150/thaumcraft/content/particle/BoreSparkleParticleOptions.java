...
public record BoreSparkleParticleOptions(int targetEntityId, double tx, double ty, double tz,
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, BoreSparkleParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.VAR_INT, BoreSparkleParticleOptions::targetEntityId,
            ByteBufCodecs.DOUBLE, BoreSparkleParticleOptions::tx,
            ByteBufCodecs.DOUBLE, BoreSparkleParticleOptions::ty,
            ByteBufCodecs.DOUBLE, BoreSparkleParticleOptions::tz,
            ByteBufCodecs.FLOAT, BoreSparkleParticleOptions::r,
            ByteBufCodecs.FLOAT, BoreSparkleParticleOptions::g,
            ByteBufCodecs.FLOAT, BoreSparkleParticleOptions::b,
            BoreSparkleParticleOptions::new);
