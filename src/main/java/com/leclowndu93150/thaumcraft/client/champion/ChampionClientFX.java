        ...
        switch (type) {
            case ChampionModifier.BOLD -> {
                if (rand.nextBoolean()) {
                    ...
                    addParticle(level, x, sy, z, new SparkParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.3F - rand.nextFloat() * 0.1F, 0.0F, 0.8F + rand.nextFloat() * 0.2F),
                            1.0F, 0.2F));
                }
            }
            case ChampionModifier.SPINED -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, new CrackShardParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.5F + rand.nextFloat() * 0.2F, 0.1F + rand.nextFloat() * 0.2F,
            ...
            case ChampionModifier.ARMORED -> {
                if (rand.nextInt(4) == 0) {
                    addParticle(level, x, y, z, new ShieldSparkParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.9F, 0.9F, 0.9F + rand.nextFloat() * 0.1F),
            ...
            case ChampionModifier.MIGHTY -> {
                if (rand.nextFloat() <= 0.3F) {
                    addParticle(level, x, y, z, new CrackShardParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.8F + rand.nextFloat() * 0.2F, 0.8F + rand.nextFloat() * 0.2F,
            ...
            case ChampionModifier.WARP -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, new WispFlameParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.8F + rand.nextFloat() * 0.2F, 0.0F, 0.9F + rand.nextFloat() * 0.1F),
            ...
            case ChampionModifier.UNDYING -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, 0.0, 0.03, 0.0, new WispFlameParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.1F + rand.nextFloat() * 0.1F, 0.8F + rand.nextFloat() * 0.2F, 0.1F + rand.nextFloat() * 0.1F),
            ...
            case ChampionModifier.SICKLY -> {
                if (rand.nextBoolean()) {
                    addParticle(level, x, y, z, 0.0, -0.02, 0.0, new FluxSwirlParticleOptions(
                            ARGB.colorFromFloat(1.0F, 0.2F, 0.6F + rand.nextFloat() * 0.1F, 0.2F + rand.nextFloat() * 0.1F),
            ...
            case ChampionModifier.TAINTED -> addParticle(level, x, y, z, 0.0, -0.01, 0.0, new FluxSwirlParticleOptions(
                    ARGB.colorFromFloat(0.25F, 0.1F + rand.nextFloat() * 0.2F, 0.0F, 0.1F + rand.nextFloat() * 0.1F),
