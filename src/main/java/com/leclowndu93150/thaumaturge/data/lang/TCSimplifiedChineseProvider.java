...
public final class TCSimplifiedChineseProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        aspect("aer", "气，风", "气，风", "风");
        aspect("terra", "地", "地", "地");
        aspect("ignis", "火", "火", "火");
        aspect("aqua", "水", "水", "水");
        aspect("ordo", "秩序，规则，纯净", "秩序，规则，纯净", "秩序");
        aspect("perditio", "熵增，混沌，解构", "熵增，混沌，解构", "毁灭之物");

        aspect("vacuos", "虚空", "虚空", "空虚之物");
        aspect("lux", "光", "光", "光明");
        aspect("motus", "移动，动作", "移动，动作", "动起来的玩意儿");
        aspect("gelum", "寒冰，霜冻，寒冷", "寒冰，霜冻，寒冷", "冰冷的东西");
        aspect("vitreus", "水晶，玻璃，澄澈", "水晶，玻璃，澄澈", "水晶");
        aspect("metallum", "金属", "金属", "金属");
        aspect("victus", "生命", "生命", "生命之源");
        aspect("mortuus", "死亡", "死亡", "死亡的天性");
        aspect("potentia", "能量，动力", "能量，动力", "能量");
        aspect("permutatio", "交换，贸易", "交换，贸易", "贸易与交换");
        aspect("praecantatio", "魔力，咒语，附魔", "魔力，咒语，附魔", "魔法物品");
        aspect("auram", "灵气", "灵气", "灵气");
        aspect("alkimia", "炼金术，化学", "炼金术，化学", "炼金术");
        aspect("vitium", "污染，变化，突变", "污染，变化，突变", "魔力之腐化影响");
        aspect("tenebrae", "黑暗", "黑暗", "黑暗");
        aspect("alienis", "异域，怪异，诡谲", "异域，怪异，诡谲", "异域奇物");
        aspect("volatus", "飞行", "飞行", "飞行");
        aspect("herba", "植物", "植物", "植物");
        aspect("instrumentum", "工具，仪器", "工具，仪器", "工具");
        aspect("fabrico", "合成", "合成", "加工");
        aspect("machina", "机构，机械", "机构，机械", "机械品");
        aspect("vinculum", "陷阱，监禁", "陷阱，监禁", "陷入罗网之物");
        aspect("spiritus", "灵魂", "灵魂", "精神");
        aspect("cognitio", "思维，记忆，认识", "思维，记忆，认识", "头脑");
        aspect("sensus", "感官", "感官", "感知");
        aspect("aversio", "憎恶，冲突", "憎恶，冲突", "冲突");
        aspect("praemunio", "强化，保护，守护", "强化，保护，守护", "守护事物");
        aspect("desiderium", "愿望，意愿，渴望，需求", "愿望，意愿，渴望，需求", "贵重物品");
        aspect("exanimis", "不死，亡灵", "不死，亡灵", "不死的天性");
        ...
        card("inspired", "启发", "受到目前现有进度的启发，你开始考虑你未曾想到的学识。你获得%1$s点 %2$s 进度。");
        card(
                "notation",
                "Notation",
        ...
        add("resourcePack.thaumaturge.programmer_art.name", "神秘时代程序员艺术");
        add("knowledge_type.thaumaturge.theory", "理论（Theory）");
        add("knowledge_type.thaumaturge.observation", "观测（Observation）");
        ...
        add("tc.inst.4", "§6极高§0");
        add("tc.inst.5", "§4危险§0");
        add("tc.type.theory", "理论（Theory）");
        add("tc.type.observation", "观测（Observation）");
    ...
    private void langNScanning() {
        ...
        add(
                ...
                "低语已汇聚成合唱，我终于明白它们想让我做什么。散布于世界各处的方尖碑并非纪念碑——它们是门，而每扇门都有钥匙。<BR>我最初遭遇血腥邪徒的那些怪异祭坛上，有一块标有四个空凹槽的拱顶石。四只眼睛必须安放其中——或制作，或交易得来——拱顶石上方的阴森能量则必须保持完好。<BR>在尝试如此鲁莽之事前，我应当先理清自己的理论。");
        add(
