...
public final class EntityAspectsProvider extends DataMapProvider {
    ...
    protected void gather(HolderLookup.Provider provider) {
        ...
        add(
                b,
                EntityType.CREAKING,
                list(TCAspects.HERBA, 15, TCAspects.SPIRITUS, 10, TCAspects.TENEBRAE, 10, TCAspects.AVERSIO, 5));
        add(
                b,
                EntityType.HAPPY_GHAST,
                list(TCAspects.BESTIA, 10, TCAspects.VOLATUS, 10, TCAspects.AER, 5, TCAspects.VICTUS, 3));
        add(
                b,
                EntityType.COPPER_GOLEM,
                list(TCAspects.METALLUM, 10, TCAspects.MACHINA, 10, TCAspects.MOTUS, 5, TCAspects.HUMANUS, 3));
