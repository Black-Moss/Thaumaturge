...
public final class VisRelayRenderer implements BlockEntityRenderer<BlockEntityVisRelay, VisRelayRenderState> {
    ...
    @Override
    public void extractRenderState(BlockEntityVisRelay relay, VisRelayRenderState state, float partialTicks,
    ...
    @Override
    public void submit(VisRelayRenderState state, PoseStack poseStack, SubmitNodeCollector collector,
        ...
        LateWorldRenderQueue.enqueue(origin, (latePose, buffers) ->
                FloatyLineRenderer.draw(latePose, buffers, target, time, BEAM_COLOR, BEAM_SPEED, 1.0F, BEAM_WIDTH));
    }
}
