...
/**
 * Equipment that gradually warps its wearer. While worn or held, each piece contributes its warp value to the wearer's
 * passive warp gain, evaluated periodically by the warp system.
 *
 * <p>
 * Implement this on the {@code Item}. Items implementing this interface display the "Warping" tooltip line
 * automatically.
 *
 * @since 1.0.0
 */
