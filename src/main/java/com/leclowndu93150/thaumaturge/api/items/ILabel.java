 ...
 *
 * <p>
 * Implementing this interface allows an item to carry an aspect filter, which can be used to restrict or categorize
 * operations (e.g., sorting, filtering) based on a particular aspect.
 */
public interface ILabel {

    /**
     * Returns the {@link IAspect} resource key that this label is filtering for, or {@code null} if no aspect filter has
     * been set on the given stack.
     *
