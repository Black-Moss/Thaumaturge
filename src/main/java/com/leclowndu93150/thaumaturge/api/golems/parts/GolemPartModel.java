...
/**
 * Visual description of a golem part: the OBJ model rendered on the golem and where it attaches. Object parts whose
 * name starts with {@code bm} sample the golem material's texture instead of {@link #texture()}.
 *
 * <p>
 * Dynamic per-part render behavior (wheel spin, dart recoil, hauler chest swap) is registered client side against the
 * owning part rather than subclassed here.
 *
 * @since 1.0.0
 */
public final class GolemPartModel {
     ...
     * @param texture the texture applied to non-material object parts, or null when every part uses the material texture
