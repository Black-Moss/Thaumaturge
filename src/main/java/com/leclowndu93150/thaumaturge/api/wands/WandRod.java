...
/**
 * A wand rod (or staff core) type. Rods determine how much primal vis a wand can store, and optionally self-charge
 * through an {@link IWandRodOnUpdate} callback. Staff cores are rods flagged as staves: they hold more vis and cast,
 * but cannot be used for arcane crafting.
 *
 * @since 1.0.0
 */
public final class WandRod {
     ...
     * @param craftCost the crafting cost factor of this rod, multiplied with the cap's factor to price wand assembly
     ...
     * @param runes whether this rod bears runes, granting a free potency level to any socketed focus
     */
     ...
     * @param assemblyResearch the research entry gating wand assembly recipes built around this rod, or null for the base
     *            auromancy gate
     */
