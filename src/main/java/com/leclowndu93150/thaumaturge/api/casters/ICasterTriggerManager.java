...
/**
 * Handles a caster right-click on a block state registered with {@link CasterTriggerRegistry}. One manager can serve
 * several block states by distinguishing them through the {@code event} number supplied at registration.
 *
 * @since 1.0.0
 */
