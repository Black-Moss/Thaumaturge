...
/**
 * An element that transforms the streams flowing to the nodes after it, such as scattering one trajectory into a cone
 * of many.
 *
 * @since 1.0.0
 */
public non-sealed interface FocusMod extends FocusElement {
    /**
     * Transforms the incoming streams. The result replaces both streams entirely; a null array in the result clears that
     * stream for the following nodes.
     *
