...
public record InfusionRecipeDisplay(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, InfusionRecipeDisplay> STREAM_CODEC = StreamCodec.composite(
            SlotDisplay.STREAM_CODEC, InfusionRecipeDisplay::catalyst,
            SlotDisplay.STREAM_CODEC.apply(ByteBufCodecs.list()), InfusionRecipeDisplay::components,
            AspectList.STREAM_CODEC, InfusionRecipeDisplay::aspects,
            ByteBufCodecs.VAR_INT, InfusionRecipeDisplay::instability,
            SlotDisplay.STREAM_CODEC, InfusionRecipeDisplay::result,
