...
public record BoreDebrisParticleOptions(BlockState state, int targetEntityId, double tx, double ty, double tz,
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, BoreDebrisParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.idMapper(Block.BLOCK_STATE_REGISTRY), BoreDebrisParticleOptions::state,
            ByteBufCodecs.VAR_INT, BoreDebrisParticleOptions::targetEntityId,
            ByteBufCodecs.DOUBLE, BoreDebrisParticleOptions::tx,
            ByteBufCodecs.DOUBLE, BoreDebrisParticleOptions::ty,
            ByteBufCodecs.DOUBLE, BoreDebrisParticleOptions::tz,
            ByteBufCodecs.DOUBLE, BoreDebrisParticleOptions::sx,
            ByteBufCodecs.DOUBLE, BoreDebrisParticleOptions::sy,
            ByteBufCodecs.DOUBLE, BoreDebrisParticleOptions::sz,
            BoreDebrisParticleOptions::new);
