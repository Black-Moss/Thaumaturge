...
public record BoltParticleOptions(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, BoltParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ...
            BoltParticleOptions::targetX,
            ByteBufCodecs.DOUBLE,
            BoltParticleOptions::targetY,
            ByteBufCodecs.DOUBLE,
            BoltParticleOptions::targetZ,
            ByteBufCodecs.FLOAT,
            BoltParticleOptions::r,
            ByteBufCodecs.FLOAT,
            BoltParticleOptions::g,
            ByteBufCodecs.FLOAT,
            BoltParticleOptions::b,
            ByteBufCodecs.FLOAT,
            BoltParticleOptions::width,
