...
public record SparkleParticleOptions(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, SparkleParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.INT, SparkleParticleOptions::color,
            ByteBufCodecs.FLOAT, SparkleParticleOptions::scale,
            ByteBufCodecs.VAR_INT, SparkleParticleOptions::delay,
            ByteBufCodecs.FLOAT, SparkleParticleOptions::decay,
            ByteBufCodecs.FLOAT, SparkleParticleOptions::gravity,
            ByteBufCodecs.VAR_INT, SparkleParticleOptions::baseAge,
            ByteBufCodecs.BOOL, SparkleParticleOptions::flicker,
