...
public record FireMoteParticleOptions(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, FireMoteParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ByteBufCodecs.DOUBLE, FireMoteParticleOptions::vx,
            ByteBufCodecs.DOUBLE, FireMoteParticleOptions::vy,
            ByteBufCodecs.DOUBLE, FireMoteParticleOptions::vz,
            ByteBufCodecs.FLOAT, FireMoteParticleOptions::r,
            ByteBufCodecs.FLOAT, FireMoteParticleOptions::g,
            ByteBufCodecs.FLOAT, FireMoteParticleOptions::b,
            ByteBufCodecs.FLOAT, FireMoteParticleOptions::alpha,
            ByteBufCodecs.FLOAT, FireMoteParticleOptions::scale,
            ByteBufCodecs.BOOL, FireMoteParticleOptions::translucent,
            FireMoteParticleOptions::new
    );
