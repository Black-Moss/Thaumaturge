...
public record InfusionCrumbsParticleOptions(
        ItemStackTemplate stack, double tx, double ty, double tz, double sx, double sy, double sz)
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, InfusionCrumbsParticleOptions> STREAM_CODEC =
            StreamCodec.composite(
                    ...
                    InfusionCrumbsParticleOptions::stack,
                    ByteBufCodecs.DOUBLE,
                    InfusionCrumbsParticleOptions::tx,
                    ByteBufCodecs.DOUBLE,
                    InfusionCrumbsParticleOptions::ty,
                    ByteBufCodecs.DOUBLE,
                    InfusionCrumbsParticleOptions::tz,
                    ByteBufCodecs.DOUBLE,
                    InfusionCrumbsParticleOptions::sx,
                    ByteBufCodecs.DOUBLE,
                    InfusionCrumbsParticleOptions::sy,
                    ByteBufCodecs.DOUBLE,
                    InfusionCrumbsParticleOptions::sz,
