...
public record InfusionCrumbsParticleOptions(ItemStackTemplate stack, double tx, double ty, double tz,
    ...
    public static final MapCodec<InfusionCrumbsParticleOptions> CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
            ItemStackTemplate.CODEC.fieldOf("item").forGetter(InfusionCrumbsParticleOptions::stack),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, InfusionCrumbsParticleOptions> STREAM_CODEC = StreamCodec.composite(
            ItemStackTemplate.STREAM_CODEC, InfusionCrumbsParticleOptions::stack,
            ByteBufCodecs.DOUBLE, InfusionCrumbsParticleOptions::tx,
            ByteBufCodecs.DOUBLE, InfusionCrumbsParticleOptions::ty,
            ByteBufCodecs.DOUBLE, InfusionCrumbsParticleOptions::tz,
            ByteBufCodecs.DOUBLE, InfusionCrumbsParticleOptions::sx,
            ByteBufCodecs.DOUBLE, InfusionCrumbsParticleOptions::sy,
            ByteBufCodecs.DOUBLE, InfusionCrumbsParticleOptions::sz,
