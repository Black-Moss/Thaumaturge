...
public final class TCMaterials {
    public static final ToolMaterial TOOL_THAUMIUM =
            new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 500, 7.0F, 2.5F, 22, TCItemTags.INGOTS_THAUMIUM);
    public static final ToolMaterial TOOL_VOID =
            new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 150, 8.0F, 3.0F, 10, TCItemTags.INGOTS_VOID_METAL);
    public static final ToolMaterial TOOL_ELEMENTAL =
            new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 1500, 9.0F, 3.0F, 18, TCItemTags.INGOTS_THAUMIUM);
    public static final ToolMaterial TOOL_PRIMAL_VOID =
            new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 500, 8.0F, 4.0F, 20, TCItemTags.INGOTS_VOID_METAL);
    public static final ToolMaterial TOOL_CRIMSON_VOID =
            new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 200, 8.0F, 3.5F, 20, TCItemTags.INGOTS_VOID_METAL);
    ...
    public static final ArmorMaterial ARMOR_ROBES = new ArmorMaterial(
            25, defense(1, 2, 3, 1), 25, SoundEvents.ARMOR_EQUIP_LEATHER, 1.0F, 0.0F, ItemTags.WOOL, ASSET_ROBES);
    ...
    public static final ArmorMaterial ARMOR_CULTIST_ROBE = new ArmorMaterial(
            17, defense(2, 4, 5, 2), 13, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, ItemTags.WOOL, ASSET_CULTIST_ROBE);
